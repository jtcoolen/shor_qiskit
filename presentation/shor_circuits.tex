...
\begin{frame}{The Toffoli: a reversible AND}
  ...
  \begin{columns}[T]
    \begin{column}{0.47\textwidth}
      \blocktitle{Why it matters}
      It permutes basis states, so it is reversible. Toffoli, CNOT and NOT build \textbf{any classical function} reversibly: every piece of arithmetic in Shor is made of them.
    \end{column}
    \begin{column}{0.47\textwidth}
...
\begin{frame}{Backup --- references}
  ...
  \begin{itemize}\setlength{\itemsep}{0.6mm}
    ...
    \item R. Griffiths, C.-S. Niu, Phys. Rev. Lett. 76 (1996). \quad C. H. Bennett, IBM J. Res. Dev. 17 (1973).
